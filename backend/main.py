...
from backend.services.mission_followup_planner import mission_follow_up_planner
...
async def startup_unified_llm():
    ...
    # Start mission follow-up planner
    try:
        await mission_follow_up_planner.start()
        print("[OK] Mission follow-up planner started")
    except Exception as e:
        print(f"[WARN] Mission follow-up planner degraded: {e}")
